...
@Component({
  selector: 'app-basico-puntos',
  templateUrl: './basico-puntos.component.html',
  styleUrls: ['./basico-puntos.component.css']
})
export class BasicoPuntosComponent implements OnInit {
